...
---------------------
Loads a trained DQN model and runs it live in the PyBoy emulator
with the SDL2 window backend so the user can watch the agent play.
"""
...
def play(config: dict, model_path: str, fps: int = 60) -> None:
    ...
    env = PokemonBlueEnv(
        ...
        frame_skip=1,                 # 1 frame per action for smooth visual playback
